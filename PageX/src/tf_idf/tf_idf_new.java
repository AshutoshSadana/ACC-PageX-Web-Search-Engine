...
public class tf_idf_new {
	...
	public static double tf_score(int key_word_count,int total_number_of_words_count) {
		...
		key_word_count=key_word_count*100;
...
//		HashMap<String, Integer> val2 = new HashMap<String, Integer>();
//		val1.put("The", 2);
//		val1.put("cat", 1);
//		val1.put("is", 1);
//		val1.put("in", 1);
...
//		map.put("doc_1", val1);
//		map.put("doc_2", val2);
//		HashMap<String, Double> tf_idf_score=cal_tf_idf_score(map,"house");
//		populate_heap(tf_idf_score);
//        
//
//
//    }
